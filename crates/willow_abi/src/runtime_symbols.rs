...
pub const RUNTIME_SYMBOLS: &[RuntimeSymbol] = runtime_abi_schema! {
    ...
    NONE; "willow_gc_survivor_copies" => ([] -> Some(I64));
    NONE; "willow_gc_survivor_bytes" => ([] -> Some(I64));
    NONE; "willow_gc_tenured_objects" => ([] -> Some(I64));
    NONE; "willow_gc_tenured_bytes" => ([] -> Some(I64));
    NONE; "willow_gc_pinned_promotions" => ([] -> Some(I64));
    NONE; "willow_gc_survivor_space_reserved" => ([] -> Some(I64));
    NONE; "willow_gc_survivor_space_live" => ([] -> Some(I64));
