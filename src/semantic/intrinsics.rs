...
pub(crate) fn builtin_call_runtime_name(callee: &str) -> Option<&'static str> {
    match callee {
        ...
        "gc_survivor_copies" => Some("willow_gc_survivor_copies"),
        "gc_survivor_bytes" => Some("willow_gc_survivor_bytes"),
        "gc_tenured_objects" => Some("willow_gc_tenured_objects"),
        "gc_tenured_bytes" => Some("willow_gc_tenured_bytes"),
        "gc_pinned_promotions" => Some("willow_gc_pinned_promotions"),
        "gc_survivor_space_reserved" => Some("willow_gc_survivor_space_reserved"),
        "gc_survivor_space_live" => Some("willow_gc_survivor_space_live"),
